...
\begin{table}[h]
	\centering
	\input{/home/karthikeya/Desktop/Probability/70/tables/Table2.tex}
...
\pr{X=1\,,\,Y=1} \neq 0 
\end{align}
The sum of the probabilities of two events A and B can be represented by:
\begin{align}
\pr{X=1}+\pr{Y=1} = x+y
\end{align}
...
\begin{table}[h]
	\centering
	\input{/home/karthikeya/Desktop/Probability/70/tables/Table3.tex}
	\caption{Random variable $X$ declaration}
        \label{tab:exemplar/12/13/3/70}
\end{table}
