...
\hhline{|-------|}
	...
	&\multicolumn{1}{|p{\gnumericColG}|}%
	 {\gnumericPB{\centering}\gnumbox{2A}}
	&\multicolumn{1}{|p{\gnumericColH}|}%
	 {\gnumericPB{\centering}\gnumbox{3A}}
	&\multicolumn{1}{|p{\gnumericColI}|}%
	 {\gnumericPB{\centering}\gnumbox{5A}}
...
\hhline{|-------|}
	...
	&\multicolumn{1}{|p{\gnumericColF}|}%
	 {\gnumericPB{\centering}\gnumbox{$\frac{3}{25}$}}
	&\multicolumn{1}{|p{\gnumericColG}|}%
	 {\gnumericPB{\centering}\gnumbox{$\frac{1}{10}$}}
	&\multicolumn{1}{|p{\gnumericColH}|}%
	 {\gnumericPB{\centering}\gnumbox{$\frac{1}{25}$}}
	&\multicolumn{1}{|p{\gnumericColI}|}%
	 {\gnumericPB{\centering}\gnumbox{$\frac{1}{25}$}}
\\
\hhline{|-------|}
