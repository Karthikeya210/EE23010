...
\begin{frame}[allowframebreaks]{C-code}
  \lstinputlisting[language=C]{/home/sameer/EE23010/KHP/codes/rand.c}
  % Include your LaTeX equations and calculations here...
\end{frame}

\begin{frame}{Python-code}
  \lstinputlisting[language=Python]{/home/sameer/EE23010/KHP/codes/rand.py}
  % Include your LaTeX equations and calculations here...
\end{frame}
...
\begin{figure}
  \centering
  \includegraphics[width=\columnwidth]{/home/sameer/EE23010/KHP/figs/figure1.png}  % Replace 'image_filename' with your image file name
...
\begin{frame}[allowframebreaks]{C-code}
  \lstinputlisting[language=C]{/home/sameer/EE23010/KHP/codes1/rand.c}
  % Include your LaTeX equations and calculations here...
\end{frame}

\begin{frame}{Python-code}
  \lstinputlisting[language=Python]{/home/sameer/EE23010/KHP/codes1/rand.py}
  % Include your LaTeX equations and calculations here...
\end{frame}
...
\begin{figure}
  \centering
  \includegraphics[width=\columnwidth]{/home/sameer/EE23010/KHP/figs/figure2.png}  % Replace 'image_filename' with your image file name
  \caption{Histogram plot of density of $Z_0$}
  \label{fig:your_label}
\end{figure}
\end{frame}
