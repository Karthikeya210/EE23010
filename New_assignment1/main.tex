...
\begin{align}
    ...
    &= \myvec{6 \\ k} (0.5)^6
\end{align}
We know that $\myvec{6 \\ k}$ is the largest when,
\begin{align}
        \text{If } n \text{ is even:} \quad k &= \frac{n}{2} \\
        \text{If } n \text{ is odd:} \quad k &= \frac{n+1}{2} \text{ or }k = \frac{n-1}{2}
\end{align}
So $\myvec{6 \\ k}$ is the greatest for 
\begin{align}
        k &= \frac{n}{2} \\
        &= 3
\end{align}
...
\begin{align}
        X=3
\end{align}
is the most likely outcome and pmf for X=3 is 
\begin{align}
