...
\begin{align}
	\comb{n}{k} &\geq \comb{n}{k-1} \label{eq: 1.1.3}\quad and \\
...
\begin{align}
   	\text{If } n \text{ is even:} \quad k &= \frac{n}{2} \label{eq: even}\\ 
       	\text{If } n \text{ is odd:} \quad k &= \frac{n+1}{2} \quad  \text{or} \quad \frac{n-1}{2} \label{eq: odd}
\end{align}
As, 
\begin{align}
   	n=6
\end{align}
We can confirm from \eqref{eq: even} that 
\begin{align}
   	k&=\frac{n}{2}\\
   	&=3
\end{align}
...
\begin{align}
        p_X(3) &= \myvec{6 \\ 3} \brak{\frac{1}{2}}^6 \\
        &= \frac{5}{16}
\end{align}
\begin{figure}
\centering
