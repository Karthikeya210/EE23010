...
\begin{align}
    P(X=k) = \myvec{n \\ k}.p^k.(1-p)^{n-k}
    \label{Equation:1.1.1}
\end{align}
From \eqref{Equation:1.1.1}, We can conclude that
\begin{align}
\text{For }x_i&=0:\\
P(X&=0)=\myvec{6 \\ 0}.(0.5)^0.(0.5)^{6} \approx 0.016\\
\text{For }x_i&=1:\\
P(X&=1)=\myvec{6 \\ 1}.(0.5)^1.(0.5)^{5} \approx 0.094\\
\text{For }x_i&=2:\\
P(X&=2)=\myvec{6 \\ 2}.(0.5)^2.(0.5)^{4} \approx 0.234\\
\text{For }x_i&=3:\\
P(X&=3)=\myvec{6 \\ 3}.(0.5)^3.(0.5)^{3} \approx 0.313\\
\text{For }x_i&=4:\\
P(X&=4)=\myvec{6 \\ 4}.(0.5)^4.(0.5)^{2} \approx 0.234\\
\text{For }x_i&=5:\\
P(X&=5)=\myvec{6 \\ 5}.(0.5)^5.(0.5)^{1} \approx 0.094\\
\text{For }x_i&=6:\\
P(X&=6)=\myvec{6 \\ 6}.(0.5)^6.(0.5)^{0} \approx 0.016\\
\end{align}
Here, we can conclude that $P(X=3)$ is the highest and hence proved that 
\begin{align}
X=3
\end{align}
