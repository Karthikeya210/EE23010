...
\begin{table}[h]
	\centering
	\input{/home/karthikeya/Desktop/Probability/New_assignment8/tables/Table2.tex}
...
\begin{table}[h]
	\centering
	\input{/home/karthikeya/Desktop/Probability/New_assignment8/tables/Table3.tex}
	\caption{Parameters}
        \label{tab:63/2022/2}
\end{table}
...
\end{align}
for large values of n, the pdf of Y converges to 
\begin{align}
	p_Y\brak{x} &= \frac{1}{\sqrt{2\pi{\sigma}^2}} e^{-\frac{\brak{x-\mu}^2}{2{\sigma}^2}}\label{9.3.11} \qquad \brak{x \in Y}
\end{align}
Q function is defined
\begin{align}
	Q\brak{x} &= \int_{x}^{\infty}p_Y\brak{t}dt\\
	&= \int_{x}^{\infty}\frac{1}{\sqrt{2\pi{\sigma}^2}} e^{-\frac{\brak{t-\mu}^2}{2{\sigma}^2}}dt\\
\end{align}
then CDF of $Y$ is:
\begin{align}
	F_Y(x)&=\int_{-\infty}^x p_Y\brak{t} dt\\
	&=1-\int_x^{\infty}p_Y\brak{t}dt\\
...
\begin{align}
	...
	&= 0.84325
\end{align}
$\therefore$ the probability that a transmitted codeword is decoded correctly is 0.84325.
\\The Binomial CDF vs. Guassian CDF plot is given in fig\ref{fig:63/2022}
\begin{figure}[ht!]
    \centering
    \includegraphics[width=\columnwidth]{/home/karthikeya/Desktop/Probability/New_assignment8/figs/figure1.png}
