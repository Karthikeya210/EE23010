...
\\ \solution 
Given that,
Let X be a random variable representing the number of bit errors introduced during transmission over the binary symmetric channel.Then, X is a binomial distribution with parameters 
\begin{align}
